                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            ...
                            @endforeach
                                    ...
                                    @else
                                    <p style="text-align: center; margin-bottom: 29px; font-weight: 800; font-size: 2rem;">No item in Cart</p>
                                    @endif
                        </div>
                        ...
                        <div class="row mb-50">
                            <div class="col-lg-6 col-md-12">
                                ...
                                <p class="mt-15 mb-30">Based on the <span class="font-xl text-brand fw-900">City and shipping system</span></p>

...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/imgs/theme/logo-sm.png') }}">
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="/"><img src="{{asset('assets/imgs/logo/logo.png')}}" alt="Hometex"></a>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href="/"><i class="Hometex-font-dress"></i>Women's Clothing</a>
                                    ...
                                    <li class="has-children">
                                        <a href="/"><i class="Hometex-font-tshirt"></i>Men's Clothing</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li class="has-children">
                                        <a href="/"><i class="Hometex-font-smartphone"></i> Cellphones</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                    ...
                                    <li><a href="/"><i class="Hometex-font-desktop"></i>Computer & Office</a></li>
                                    <li><a href="/"><i class="Hometex-font-cpu"></i>Consumer Electronics</a></li>
                                    <li><a href="/"><i class="Hometex-font-diamond"></i>Jewelry & Accessories</a></li>
                                    <li><a href="/"><i class="Hometex-font-home"></i>Home & Garden</a></li>
                                    <li><a href="/"><i class="Hometex-font-high-heels"></i>Shoes</a></li>
                                    <li><a href="/"><i class="Hometex-font-teddy-bear"></i>Mother & Kids</a></li>
                                    <li><a href="/"><i class="Hometex-font-kite"></i>Outdoor fun</a></li>
                                    <li>
                                        <ul class="more_slide_open" style="display: none;">
                                            <li><a href="/"><i class="Hometex-font-desktop"></i>Beauty, Health</a></li>
                                            <li><a href="/"><i class="Hometex-font-cpu"></i>Bags and Shoes</a></li>
                                            <li><a href="/"><i class="Hometex-font-diamond"></i>Consumer Electronics</a></li>
                                            <li><a href="/"><i class="Hometex-font-home"></i>Automobiles & Motorcycles</a></li>
                                        </ul>
                                    </li>
                                </ul>
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="product-details.html"><img src="assets/imgs/banner/menu-banner.jpg" alt="Hometex"></a>
                    ...
                    <div class="hotline d-none d-lg-block">
                        <p><i class="fi-rs-smartphone"></i><span>CUSTOMER CARE:</span> 01616101090 </p>
                    </div>
                        ...
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href="{{ route('shop.wishlist') }}">
                                    <img alt="Hometex" src="{{ asset('assets/imgs/theme/icons/icon-heart.svg')}}">
                                    <span class="pro-count white">4</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{ route('shop.cart') }}">
                                    <img alt="Hometex" src="assets/imgs/theme/icons/icon-cart.svg">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Hometex" src="{{ asset('assets/imgs/shop/thumbnail-3.jpg')}}"></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="product-details.html"><img alt="Hometex" src="assets/imgs/shop/thumbnail-4.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href="/"><i class="Hometex-font-dress"></i>Women's Clothing</a></li>
                                <li><a href="/"><i class="Hometex-font-tshirt"></i>Men's Clothing</a></li>
                                <li> <a href="/"><i class="Hometex-font-smartphone"></i> Cellphones</a></li>
                                <li><a href="/"><i class="Hometex-font-desktop"></i>Computer & Office</a></li>
                                <li><a href="/"><i class="Hometex-font-cpu"></i>Consumer Electronics</a></li>
                                <li><a href="/"><i class="Hometex-font-home"></i>Home & Garden</a></li>
                                <li><a href="/"><i class="Hometex-font-high-heels"></i>Shoes</a></li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            ...
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Store # 354-355, Level # 03, Twin Tower Concord Dhaka 1217
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+880197 1 66 38 39
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong> +880197 2 66 38 39
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+880197 8 66 38 39
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>info@hometex.ltd
                            </p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">Hometex</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
